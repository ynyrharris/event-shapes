...
class EventShapes : public TObject {
	...
	public:
		...
		void calc_all();
		void calc_thrusts();
		void calc_sphericities(float r=1.);
		...
		double get_spher_S() { return m_spher_S; }
		double get_spher_A() { return m_spher_A; }
		double get_spher_C() { return m_spher_C; }
		double get_spher_D() { return m_spher_D; }
	...
	public:
		...
		double m_spher_S;
		double m_spher_A;
		double m_spher_C; // 3 jet structure
		double m_spher_D; // 4 jet structure
